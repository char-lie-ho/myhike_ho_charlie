...
function writeReview() {
    ...
    let hikeFlooded = document.querySelector('input[name="flooded"]:checked').value;  //Query selector for radio buttons
    let hikeScrambled = document.querySelector('input[name="scrambled"]:checked').value; //Query selector for radio buttons
